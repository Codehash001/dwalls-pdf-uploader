...
<div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
  ...
  return (
    <div className="w-full min-h-screen bg-white mx-auto md:p-20 p-8 flex flex-col items-center ">
      <div className=" flex flex-col space-y-6 ">
      <h1 className="text-black md:text-5xl text-3xl text-center font-bold">Upload and Ingest Your Data</h1>
      <label>
        <input
          type="file"
          multiple
      ...
      <div className="md:flex flex-1 md:space-x-8 space-x-0 space-y-6 md:space-y-0">
        <div className="max-w-5xl text-black border-2 border-black border-dotted p-10 space-y-2">
...
>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-white"><path d="M6 22h12a2 2 0 0 0 2-2V8l-6-6H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2zm7-18 5 5h-5V4zM8 14h3v-3h2v3h3v2h-3v3h-2v-3H8v-2z"></path></svg>
            ...
            <div className="max-w-5xl text-black space-y-2 border border-gray-300 rounded-md bg-gray-100 p-10">
        ...
        {allfiles.map((file) => (
          <li className="space-x-6 flex items-center my-4 justify-between border-b-2 border-gray-200 py-2" key={file}>
            <div className="font-semibold md:text-[20px]">{file}{" "}</div>
      ...
      <div className="flex space-x-5 text-black md:justify-start justify-center items-center">
        <button
